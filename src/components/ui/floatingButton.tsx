    ...
    <div className="fixed bottom-6 right-6 z-50 pb-[env(safe-area-inset-bottom)]">
      <Dialog open={open} onOpenChange={(newOpen) => {
        ...
        <DialogTrigger asChild>
          <button
            className={`w-14 h-14 bg-primary hover:bg-blue-700 text-white rounded-full flex items-center justify-center shadow-lg transition-all duration-300 ${isBouncing ? 'animate-bounce' : ''
              }`}
            aria-label="Text us"
          >
