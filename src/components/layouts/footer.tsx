...
export default function Footer() {
  return (
    <footer className="bg-tertiary text-white py-8 px-2 sm:px-4 md:px-8">
      <div className="mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
        ...
        <div className="space-y-4 col-span-1">
          ...
          <p className="text-xs sm:text-sm text-white">
            Tulip Dental is your trusted dentist in Maplewood, NJ, delivering
            exceptional family, cosmetic, and restorative dental care with
            advanced treatments and personalized attention. Our skilled team
            provides everything from routine cleanings, fillings, and preventive
            care to professional teeth whitening, porcelain veneers, dental
        ...
        <div className="col-span-1 sm:col-span-1 lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm">
              ...
              <li>
                <Link href="/services/root-canal" className="hover:underline">
                  Root Canal
                </Link>
              </li>
              <li>
                <Link href="/services/oral-surgery" className="hover:underline">
                  Oral Surgery
                </Link>
              </li>
              <li>
        ...
        <div className="space-y-4 col-span-1">
          ...
          <div className="text-xs sm:text-sm text-gray-200">
            ...
            <p className="mb-2 text-sm text-[#FFFFFF] flex gap-2 items-center">
              <Mail size={16} />{" "}
              <a
                href="mailto:maplewood@tulipdentalnj.com"
                className="underline"
              >
