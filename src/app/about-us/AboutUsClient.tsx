        ...
        <div className="flex-1 space-y-4 sm:space-y-6 lg:pr-8 order-2 lg:order-1 w-full">
          ...
          <Fade delay={500}>
            <p>
              ...
              Dental provides modern, compassionate dental care for patients of
              every age. Conveniently located in Maplewood, we proudly serve
              families and individuals from{" "}
              <strong>
                Maplewood (07040), South Orange (07079), Irvington (07111),
                Vauxhall (07088){" "}
              </strong>
              , and <strong>Newark</strong> neighborhoods including{" "}
              <strong>07106 </strong> and <strong>07112</strong>. Our
              experienced team offers preventive care, restorative solutions,
              and cosmetic treatments - all in a relaxed, family-friendly
              environment.{" "}
            </p>
          </Fade>
          <Fade delay={700}>
            <p>
              ...
              advanced cosmetic treatment, our friendly and experienced team at
              Tulip Dental Maplewood is here to help. We proudly offer a full
              range of services - from preventive cleanings to smile makeovers -
              all delivered in a modern, welcoming environment. Every treatment
              plan is personalized to meet your unique needs and goals, ensuring
          ...
          <div className="flex justify-left">
            <button
              className="group bg-primary text-white px-4 py-2.5 md:px-6 md:py-3 lg:px-8 lg:py-4 rounded-lg md:rounded-xl font-semibold text-sm md:text-base lg:text-lg hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105 flex items-center gap-2"
        ...
        <section className="flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-8 py-8 sm:py-12 lg:py-16 px-4 sm:px-8 lg:px-16 max-w-7xl mx-auto">
          ...
          <div className="flex-1 lg:pl-12 order-1 lg:order-2">
            ...
            <p>
              ...
              allowing us to detect and address issues early while using
              minimally invasive techniques. Your comfort is our top priority,
              and we focus on making each visit efficient, stress-free, and
              informative.
            </p>
