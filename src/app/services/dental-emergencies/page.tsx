...
export default function DentalEmergencyPage() {
  ...
  },
  {
        ...
        <div className='details-page'>
                    <div className='details-page-header-section'>
                        ...
                        <p className="text-center">
                            Emergency Dental Services in Harrisburg | Maple Dental | Family & Cosmetic Dentist
                        </p>
                        </Fade>
                    ...
                    <div className='wcu-text-section'>
                      <Fade cascade direction="up" delay={1000} duration={600}>
                        ...
                        <div className='wcu-title'>
                          Why Choose Maple Dental for Emergency Dental Services?
                        </div>
    ...
    <div className='faq-section'>
           <h4 className='faq-heading'>Dental Emergency Q&A</h4>
           <div className="faq-acc-container">
            <Accordion type="single" className="w-full space-y-5">
        
        <AccordionItem value="q1" className="faq-acc">
          <AccordionTrigger className='faq-qn'>What qualifies as a dental emergency?</AccordionTrigger>
        ...
        <AccordionItem value="q2" className="faq-acc">
          <AccordionTrigger className='faq-qn'>What are common dental emergencies you treat?</AccordionTrigger>
          <AccordionContent className='faq-ans'>
        ...
        <AccordionItem value="q3" className="faq-acc">
          <AccordionTrigger className='faq-qn'>What should I do before reaching the dentist?</AccordionTrigger>
          <AccordionContent className='faq-ans'>
        ...
        <AccordionItem value="q4" className="faq-acc">
          <AccordionTrigger className='faq-qn'>How can I avoid dental emergencies?</AccordionTrigger>
          <AccordionContent className='faq-ans'>
            <p>
