          ...
          <div className='details-page-header-section'>
            ...
            <Fade direction='down' duration={1000}>
              <h2 className="text-center">
                Braces & Clear Aligners in Maplewood | Tulip Dental | Family & Cosmetic Dentist                        </h2>
            </Fade>
          ...
          <div className='details-page-desc-section'>
            ...
            <div className='desc-text-section'>
              <Fade cascade direction="up" delay={1000} duration={600}>
                ...
                <p>
                  Patients from Maplewood (07040), South Orange (07079), Vauxhall (07088), Irvington (07111), and Newark (07106, 07112) trust us for expert orthodontic care. If you’ve been searching for “braces near me” or “Invisalign near Maplewood,” your smile is in the right hands.                </p>
              </Fade>
            </div>
          </div>
              ...
              <Fade cascade direction="up" delay={1000} duration={600}>
                ...
                <div className='wcu-points-section'>
                  <ul className='wcu-points'>
                    ...
                    <li>
                      <h3 className="text-lg flex items-center gap-2">
                        <CheckCircle /> Early Orthodontic Screenings for Children
                      </h3>
                    </li>
                    <li>
                      <h3 className="text-lg flex items-center gap-2">
                        <CheckCircle /> Flexible Financing & Insurance Assistance
                      </h3>
                    </li>
                  </ul>
                </div>
          ...
          <div className="features-section">
            <Fade direction="up" duration={1000}>
              ...
              <p className="features-description">
                Orthodontic care works by gently shifting teeth into ideal positions over time-improving bite alignment, aesthetics, and oral health. Whether you’re a teen or adult, we walk you through every step with clarity and care.
                <br /><br />
