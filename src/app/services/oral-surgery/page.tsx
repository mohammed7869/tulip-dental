...
export default function OralSurgeryPage() {
  ...
  },
  {
    ...
    <div className='faq-section'>
           <h4 className='faq-heading'>Oral Surgery Q&A</h4>
           <div className="faq-acc-container">
            <Accordion type="single" className="w-full space-y-5">
        
        <AccordionItem value="q1" className="faq-acc">
          <AccordionTrigger className='faq-qn'>What is considered oral surgery?</AccordionTrigger>
        ...
        <AccordionItem value="q2" className="faq-acc">
          <AccordionTrigger className='faq-qn'>Do tooth extractions hurt?</AccordionTrigger>
          <AccordionContent className='faq-ans'>
        ...
        <AccordionItem value="q3" className="faq-acc">
          <AccordionTrigger className='faq-qn'>How do I know if my wisdom teeth need to be removed?</AccordionTrigger>
          <AccordionContent className='faq-ans'>
        ...
        <AccordionItem value="q4" className="faq-acc">
          <AccordionTrigger className='faq-qn'>What should I do after an extraction or surgery?</AccordionTrigger>
          <AccordionContent className='faq-ans'>
            <p>
        ...
        <AccordionItem value="q5" className="faq-acc">
          <AccordionTrigger className='faq-qn'>Is oral surgery covered by insurance?</AccordionTrigger>
          <AccordionContent className='faq-ans'>
            <p>
