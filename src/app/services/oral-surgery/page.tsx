              ...
              <div className="image_section-cover">
                <Zoom cascade damping={0.3} duration={800}>
                  <div className="main-image">
                    <img src="/Images/Oral Surgery.jpg" alt="Main Banner" />
                  </div>
                  {/* <img
            ...
            <div className="desc-text-section">
              <Fade cascade direction="up" delay={1000} duration={600}>
                ...
                <p>
                  ...
                  Whether you need a simple tooth extraction, wisdom tooth
                  removal, or more complex surgical care, our experienced team
                  is here to help.We provide in-house surgical procedures using
                  advanced tools and sedation options for maximum comfort.{" "}
                </p>
                <p>
                  Patients from Maplewood (07040), South Orange (07079),
                  Vauxhall (07088), Irvington (07111), and nearby areas of
                  Newark (07106, 07112) trust us for convenient, compassionate
                  surgical care-right in their neighborhood. If you're searching
                  for an "oral surgeon near me," Tulip Dental is nearby and
                  ready to support your dental health with precision and care.{" "}
                </p>
              </Fade>
            </div>
          </div>
          ...
          <div className="features-section">
            <Fade direction="up" duration={1000}>
              ...
              <p className="features-description">
                ...
                goal is to make every surgical procedure-from extractions to
                minor jaw surgeries-as smooth and pain-free as possible. We use
                advanced diagnostics, modern techniques, and gentle care every
                step of the way.
                <br />
                <br />
