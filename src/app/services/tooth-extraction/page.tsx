...
export default function ToothExtractionPage() {
  ...
  },
  {
                    ...
                    <div className='wcu-text-section'>
                      <Fade cascade direction="up" delay={1000} duration={600}>
                        ...
                        <div className='wcu-title'>
                          Why Choose Maple Dental for Tooth Extractions?
                        </div>
    ...
    <div className='faq-section'>
           <h4 className='faq-heading'>Tooth Extraction Q&A</h4>
        ...
        <AccordionItem value="q2" className="faq-acc">
          <AccordionTrigger className='faq-qn'>Is tooth extraction painful?</AccordionTrigger>
          <AccordionContent className='faq-ans'>
        ...
        <AccordionItem value="q3" className="faq-acc">
          <AccordionTrigger className='faq-qn'>How long is the recovery period?</AccordionTrigger>
          <AccordionContent className='faq-ans'>
        ...
        <AccordionItem value="q4" className="faq-acc">
          <AccordionTrigger className='faq-qn'>What should I eat after a tooth extraction?</AccordionTrigger>
          <AccordionContent className='faq-ans'>
            <p>
        ...
        <AccordionItem value="q5" className="faq-acc">
          <AccordionTrigger className='faq-qn'>Do I need a replacement after extraction?</AccordionTrigger>
          <AccordionContent className='faq-ans'>
            <p>
                Yes, if a permanent tooth is removed, options like implants or bridges are recommended to restore function.
            </p>
          </AccordionContent>
        </AccordionItem>
