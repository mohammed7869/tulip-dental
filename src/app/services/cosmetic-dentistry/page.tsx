...
export default function CosmeticDentistryPage() {
  ...
  },
  {
    ...
    <div className='faq-section'>
           <h4 className='faq-heading'>Cosmetic Dentistry Q&A</h4>
        ...
        <AccordionItem value="q2" className="faq-acc">
          <AccordionTrigger className='faq-qn'>Is cosmetic dentistry painful?</AccordionTrigger>
          <AccordionContent className='faq-ans'>
        ...
        <AccordionItem value="q3" className="faq-acc">
          <AccordionTrigger className='faq-qn'>How long do cosmetic results last?</AccordionTrigger>
          <AccordionContent className='faq-ans'>
        ...
        <AccordionItem value="q4" className="faq-acc">
          <AccordionTrigger className='faq-qn'>Can I combine treatments?</AccordionTrigger>
          <AccordionContent className='faq-ans'>
            <p>
