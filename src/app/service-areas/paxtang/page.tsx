    ...
    <div>
      ...
      <div className="details-page-header-section ">
        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-5xl ">
          Family & Cosmetic Dentist in Newark, NJ 07106 & 07112{" "}
        </h1>
      </div>
            ...
            <Fade cascade direction="up" delay={1000} duration={600}>
              ...
              <div className="wcu-points-section">
                <ul className="wcu-points">
                  <li>
                    <CheckCircle /> Patient-focused, compassionate approach
                  </li>
                  <li>
                    <CheckCircle /> State-of-the-art equipment for better
                    comfort &amp; accuracy
                  </li>
                  <li>
                    <CheckCircle /> Same-day appointments for emergencies
                  </li>
                  <li>
                    <CheckCircle /> Flexible scheduling and financing options
                  </li>
                  <li>
                    <CheckCircle /> Convenient location close to Newark
                    neighborhoods
                  </li>
                </ul>
              </div>
                  ...
                  return (
                    <li
                      ...
                      className={`text-white ${
                        isToday ? "bg-white/10 border-2 border-secondary" : ""
                      }`}
                    >
                      {hour}
                    </li>
