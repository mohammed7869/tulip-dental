    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 flex flex-col gap-16">
        ...
        <div className='details-page-desc-section'>
          ...
          <div className='desc-text-section'>
            <Fade cascade direction="up" delay={1000} duration={600}>
              <h2 className='text-2xl sm:text-3xl lg:text-4xl font-semibold'>Complete Dental Care in Maplewood | Tulip Dental | Family & Cosmetic Dentist</h2>
              <p>
                At Tulip Dental, we proudly provide top-quality dental care to residents of Lawnton in Harrisburg, PA (zip code 17111). Whether you're new to the area or looking for a dependable “dentist near me,” our friendly team is here to meet your needs with personalized care and advanced treatment options.
              </p>
              <p>
                Our practice is committed to serving individuals and families throughout Maplewood with services that support healthy, confident smiles—from routine cleanings to full smile transformations.
              </p>
            </Fade>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4 p-6 md:p-0">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold">Dental Services Available for Maplewood Patients</h2>

          <p>
            Located in Maplewood, our modern dental office is fully equipped to offer comprehensive dental services in a relaxing, welcoming environment. We proudly care for patients of all ages in the 07040 area with services such as:
          </p>
