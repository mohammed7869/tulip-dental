...
export default function ServiceAreasPage() {
  ...
  // },
    ...
    mapUrl:
      // "https://www.googl e.com/maps/embed?pb=!1m18!1m12!1m3!1d48699.53187959969!2d-76.92187807181904!3d40.28195319387061!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c8c116b8079e97%3A0xbb6e42c8128d46d5!2sHarrisburg%2C%20PA%2C%20USA!5e0!3m2!1sen!2sin!4v1753263853796!5m2!1sen!2sin",
  ...
  return (
    <div>
      ...
      <div className="details-page-header-section ">
        <h1>
          Family & Cosmetic Dentistry in Progress, Harrisburg, PA (17109, 17111)
        </h1>
      </div>
        ...
        <div className='details-page-desc-section'>
                ...
                <div className="image_section-cover">
                  <Zoom cascade damping={0.3} duration={800}>
                    <div className="main-image">
                      <img
                        src="/Images/Servicearea4 (1).webp"
              ...
              <div className='desc-text-section'>
                <Fade cascade direction="up" delay={1000} duration={600}>
                  ...
                  <p>
                   Our experienced and friendly team delivers a full range of dental services, from preventive care and pediatric dentistry to advanced cosmetic and restorative treatments. Join the many Progress residents who trust us with their family’s oral health.
                  </p>
                </Fade>
              </div>
            </div>
...
Our state-of-the-art dental office is conveniently located to serve families and individuals living in and around Progress. We combine modern technology, flexible scheduling, and a warm atmosphere to provide exceptional care across the following services:
          ...
          <ul className="list-disc pl-6 space-y-2 text-sm md:text-lg">
            <li>
              ...
              <span>Same-day emergency care for dental pain, broken teeth, and urgent oral health needs.</span>
            </li>
            <li>
              <span className="font-semibold">Preventive Dentistry</span><br />
              <span>Routine cleanings, exams, fluoride treatments, and education to support long-term oral health.</span>
            </li>
            <li>
              <span className="font-semibold">Cosmetic Dentistry</span><br />
              <span>Smile makeovers with Invisalign®, teeth whitening, and natural-looking veneers.</span>
            </li>
            <li>
              <span className="font-semibold">Restorative Dentistry</span><br />
              <span>Crowns, bridges, tooth-colored fillings, and dental implants to restore your smile’s strength and beauty.</span>
            </li>
            <li>
              <span className="font-semibold">Pediatric Dentistry</span><br />
              <span>Gentle and caring dental treatment for infants, children, and teens in a kid-friendly environment.</span>
            </li>
          </ul>
        </div>
...
Maple Dental is the go-to dentist for many families in Progress and surrounding areas of 17109 and 17111. Here's why:
                                ...
                                <div className='wcu-points-section'>
                                  <ul className='wcu-points'>
                                    <li><CheckCircle />Transparent, patient-first care in a friendly environment</li>
                                    <li><CheckCircle />Modern tools for accurate diagnosis and comfortable treatment</li>
                                    <li><CheckCircle />Same-day appointments available for dental emergencies</li>
                                    <li><CheckCircle />Insurance-friendly with financing and payment plans offered</li>
                                    <li><CheckCircle />Centrally located near Progress with easy access and parking</li>
                                  </ul>
                                </div>
                              </Fade>
                            </div>
                            <div className='wcu-img-section'>
                              <Zoom cascade damping={0.3} duration={800}>
                                <img src="/Images/progress service area.webp" alt="dental" className='rounded-xl' />
                              </Zoom>
                            </div>
        ...
        <div className="features-section">
                        <Fade direction="up" duration={1000}>
                          <h2 className="features-heading">
                            Schedule Your Appointment in Progress Today
                          </h2>
