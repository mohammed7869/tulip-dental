            ...
            <Fade cascade direction="up" delay={1000} duration={600}>
              ...
              <div className="wcu-points-section">
                <ul className="wcu-points">
                  <li>
                    <CheckCircle /> Personalized, patient-first dental care
                  </li>
                  <li>
                    <CheckCircle /> Advanced technology for precision and
                    comfort
                  </li>
                  <li>
                    <CheckCircle /> Same-day emergency visits available
                  </li>
                  <li>
                  ...
                  <li>
                    <CheckCircle /> Convenient location serving the entire Union
                    & Essex County area
                  </li>
                </ul>
              </div>
